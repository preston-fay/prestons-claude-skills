# Observable Framework — Full Template Reference

Complete HTML templates, component patterns, and SVG sizing fixes.
Referenced by SKILL.md — load this when building slides.
